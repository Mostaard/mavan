...
class ImgurImage(models.Model):
    ...
    imgur_album = models.ForeignKey(ImgurAlbum, null=True, blank=True, on_delete=models.CASCADE, related_name='images')
